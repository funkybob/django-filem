...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('#dropzone button').addEventListener('click', (ev) => {
    ...
    dirlist.el.addEventListener('path', () => {
    ...
    filelist.el.addEventListener('setpath', (ev) => { dirlist.path = ev.detail; });
